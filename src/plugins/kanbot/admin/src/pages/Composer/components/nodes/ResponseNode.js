...
import { IconButton, Box, Status, Typography, Stack, Select, Option } from '@strapi/design-system';
   ...
   <div className="x_node_content">
       <div className="x_node_case">
          <Status variant="neutral" showBullet={false} className="x_node_case_item">
           ...
           <Status variant="neutral0" showBullet={false} className="x_node_case_item">
                   <span><TbArrowRampRight2 color='#8d8d8d'/> Mẫu trả lời tin nhắn</span>
